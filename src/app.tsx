...
function SearchBar(props: { onSearch(req: SearchRequest): void }) {
  ...
  const [articlesCount, setArticlesCount] = useState(100);
  const [articlesSource, setArticlesSource] = useState("semantic-scholar");
  const [articlesExcludeEmpty, setArticlesExcludeEmpty] = useState(false);
